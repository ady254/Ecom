            ...
            <div className="hidden md:flex items-center gap-1">
              {navLinks.map((link) =>
                link.children ? (
                  ...
                  >
                    <button className="flex items-center gap-1 px-3 py-2 text-sm font-medium tracking-wider text-[var(--color-navy)] hover:text-[var(--color-gold-dark)] transition-colors rounded-lg hover:bg-gray-50">
                      {link.label}
                  ...
                  <Link
                    key={link.href}
                    href={link.href}
                    className={`px-3 py-2 text-sm font-medium tracking-wider transition-colors rounded-lg hover:bg-gray-50 ${
                      pathname === link.href
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="sticky top-[64px] z-40 bg-white border-b border-gray-100 shadow-lg overflow-hidden md:hidden"
          >
            <div className="section-container py-4 space-y-1">
              ...
              <div className="flex items-center gap-3 px-3 pt-3 border-t border-gray-100 mt-2">
                ...
                <Link href="/search" onClick={() => setIsMenuOpen(false)} className="flex items-center gap-2 text-sm text-gray-600 hover:text-[var(--color-navy)]">
